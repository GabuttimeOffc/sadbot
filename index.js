...
const ow = 'AGUS'; // GANTI PAKE NAMA MU
const nomorowner = '082394002751'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = '0823-9400-2751'; // GANTI PAKE NOMOR OVO LU
const pulsa = '0823-9400-2751'; // GANTI PAKE NOMOR PULSA LU
const dana = '0823-9400-2751'; // GANTI PAKE NOMOR DANA LU
const gopay = '0823-9400-2751'; // GANTI PAKE NOMOR GOPAY LU
const instagram = 'http://www.instagram.com/gabuttime.offc'; // GANTI IG LU
const aktif = '08:00 - 22:00'; // TERSERAH LU DAH INI
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n' // MAU NGAPAIN TOD
  + 'FN:AGUS\n' // GANTI PAKE NAMA MU
  + 'ORG:OWNER BOT;\n' // INI BIARIN GPP, GANTI PAKE NAMA BOT BOLEH
  + 'TEL;type=CELL;type=VOICE;waid=6282394002751:+62 823-9400-2751\n' // GANTI PAKE NOMOR LU ( SAMAIN KEK GITU YA )
